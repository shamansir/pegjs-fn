module.exports = (function(){
  ...
  var __p_blocks = (function() { return function() {
    ...
    // through _CTX variable which they expand into their arguments. Arguments
    // names are precalculated during parser generation process.
    
    // _CODE and _CTX variables are named so creepy just to ensure that parser writer will not use them
    // for naming variables in his code (only _CTX may clash in this architecture, in fact),
    ...
    return {
      ...
      "rule": [
        function(_CTX) {
          ...
          })(_CTX.name,_CTX.displayName,_CTX.expression);
        }
      ],
      "choice": [
        function(_CTX) {
      ...
      "class": [
        function(_CTX) {
          ...
          })(_CTX.inverted,_CTX.parts,_CTX.flags);
        }
      ],
      "classCharacterRange": [
        function(_CTX) {
  ...
  // for naming variables in his code (only _CTX may clash in this architecture, in fact),
  // we hope any modern environment supports Unicode now
  var _CODE = null; // holds a pointer to current rule blocks, will be initialized in parse() function
  ...
  /* =========== PARSER-DEPENDENT CODE =========== */
    ...
    rules.doubleQuotedString = function() {
      var _code = _CODE.doubleQuotedString;
      return (
        action(
          seqnc(
            match("\""),
    ...
    rules.simpleDoubleQuotedCharacter = function() {
      var _code = _CODE.simpleDoubleQuotedCharacter;
      return (
        action(
          seqnc(
            not(
    ...
    rules.singleQuotedString = function() {
      var _code = _CODE.singleQuotedString;
      return (
        action(
          seqnc(
            match("'"),
    ...
    rules.simpleSingleQuotedCharacter = function() {
      var _code = _CODE.simpleSingleQuotedCharacter;
      return (
        action(
          seqnc(
            not(
    ...
    rules.classCharacterRange = function() {
      var _code = _CODE.classCharacterRange;
      return (
        action(
          seqnc(
            label("begin",
    ...
    rules.classCharacter = function() {
      var _code = _CODE.classCharacter;
      return (
        action(
          label("char_",
    ...
    rules.simpleBracketDelimitedCharacter = function() {
      var _code = _CODE.simpleBracketDelimitedCharacter;
      return (
        action(
          seqnc(
            not(
    ...
    rules.simpleEscapeSequence = function() {
      var _code = _CODE.simpleEscapeSequence;
      return (
        action(
          seqnc(
            match("\\"),
    ...
    rules.zeroEscapeSequence = function() {
      var _code = _CODE.zeroEscapeSequence;
      return (
        action(
          seqnc(
            match("\\0"),
    ...
    rules.hexEscapeSequence = function() {
      var _code = _CODE.hexEscapeSequence;
      return (
        action(
          seqnc(
            match("\\x"),
    ...
    rules.unicodeEscapeSequence = function() {
      var _code = _CODE.unicodeEscapeSequence;
      return (
        action(
          seqnc(
            match("\\u"),
    ...
    rules.eolEscapeSequence = function() {
      var _code = _CODE.eolEscapeSequence;
      return (
        action(
          seqnc(
            match("\\"),
