...
module.exports = function(ast) {
  ...
  var apply = utils.buildNodeVisitor({
  ...
  function collectTypes(nodes) {
    var result = [];
    utils.each(nodes, function(node) { result.push(node.type); });
    return result;
  }
