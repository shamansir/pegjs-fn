    ...
    var name,
        ...
        sources = {
          grammar: [
            ...
            '  var _coord_cache = [ 0, 1, 1, 0 ]; // cache of 2d position: [ last_pos, line, column, seen_cr ]',
            '  function _coord(pos) {',
            '    /*',
            ...
            '    if (pos !== c[0]) {',
            '      if (pos < c[0]) {',
            '        _coord_cache = [ 0, 1, 1, 0 ];',
            '      } else {',
            '        ln = c[1], col = c[2], cr = c[3];',
            '      }',
            '      var from = c[0], to = pos;',
            ...
            '      function line() { return _coord(#{POS})[1]; };',
            '      function column() { return _coord(#{POS})[0]; };',
            '      function cell() { return _coord(#{POS}); };',
            '      ',
            '      #if initializerDef',
            '        ',
            '        /* INITIALIZER */',
