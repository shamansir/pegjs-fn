...
module.exports = function(ast, options) {
  ...
  var emit = buildNodeVisitor({
    grammar: function(node) {
      ...
      if (!startRule && hasRuleNamedStart) startRule = 'start';
      if (!startRule && (rulesNames.length > 0)) startRule = rulesNames[0];
      if (!startRule) startRule = '';
