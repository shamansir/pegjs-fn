...
module.exports = function(ast, options) {
  ...
  var PRIVATE_VAR_PREFIX = ''; // '__p', '$_', ...

  var INPUT_VAR = 'input',
      POS_VAR = PRIVATE_VAR_PREFIX + 'pos',
      PREV_POS_VAR = PRIVATE_VAR_PREFIX + 'p_pos';
    ...
    var name,
        ...
        sources = {
          grammar: [
            ...
            '     var _2d_cch = [ 0, 1, 1, 0 ]; // cache of 2d position: [ last_pos, line, column, seen_cr ]',
            '     function _2dpos(pos) {',
            '       /*',
            ...
            '            _2d_cch = [ 0, 1, 1, 0 ];',
            '          } else {',
            '            ln = _2d_cch[1], col = _2d_cch[2],',
            '            cr = _2d_cch[3];',
            '          }',
            '          advance(_2d_cch[0], pos);',
            '          _2d_cch = [ pos, ln, col, cr ];',
            '          return [ ln, col ];',
            '        } else return [ _2d_cch[1], _2d_cch[2] ];',
            '        ',
            '     }',
            '    ',
            ...
            '        function line() { return _2dpos(#{POS})[1]; };',
            '        function column() { return _2dpos(#{POS})[0]; };',
            '        function cell() { return _2dpos(#{POS}); };',
            '      #end',
            '      ',
            '      #if initializerDef',
            '        ',
