    ...
    var name,
        ...
        sources = {
          grammar: [ 
            ...
            '  }',
            '  ',
            '  function xpos(pos) { // convert position to 2D',
            '    /*',
            ...
            '      if (cctx.__p) cctx = cctx.__p;',
            '      else throw new Error(\'reached top context level\');',
            '    }',
            ...
            */
            ...
            '    function xpre(code) {',
            '      return code(cctx, pos) ? failed(cc(), EOI)',
            '                             : \'\';',
            '    }',
            '    xpre = def(xpre);',
            '  ',
          ...
          semantic_and: [
            'pre(function(ctx, cpos) {',
            '  #block code',  
            '})'
          ],
          semantic_not: [
            'xpre(function(ctx, cpos) {',
            '  #block code',  
            '})'
          ],
          optional: [
